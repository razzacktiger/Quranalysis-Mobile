...
import { AppThemeProvider, useTheme } from '@/lib/hooks';
...
function RootLayoutNav() {
  ...
  useEffect(() => {
    ...
    if (!user && !inAuthGroup) {
      ...
      // Redirect to main app if authenticated and still in auth group
      router.replace('/(tabs)');
    }
  ...
  return (
    <ThemeProvider value={colorScheme === 'dark' ? DarkTheme : DefaultTheme}>
      <Stack>
        ...
        <Stack.Screen name="session/edit/[id]" options={{ title: 'Edit Session' }} />
